...
Detailed stage-by-stage history of what was built and why. For a current overview see
[README.md](../README.md); for how the code is organized see [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md);
for setup steps see [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md).
